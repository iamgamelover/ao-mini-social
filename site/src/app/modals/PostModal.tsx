...
import { AO_STORY, MINI_SOCIAL, STORY_INCOME, TIP_IMG } from '../util/consts';
...
class PostModal extends React.Component<PostModalProps, PostModalState> {
  ...
  async onPost() {
    ...
    if (this.props.isStory)
      ...
      response = await messageToAO(MINI_SOCIAL, data, 'SendPost');
    ...
    if (response) {
      ...
      if (!this.props.isStory) {
        ...
        messageToAO(MINI_SOCIAL, idInfo, 'SendPostID');
      }
      else {
